...
?>
    <form method="post" action="add_person.php">
        ...
        <p><input name="games"> Wie Viele Gewertete Schach Spiele:</p>
...
echo "<table border=´1´>";
    echo "<tr><th>Nummer</th><th>Alter</th><th>Name</th><th>Vorname</th><th>ELO</th><th>PLZ</th><th>Hausnummer</th><th>Straße</th><th>E-Mail</th><th>Games</th></tr>";
