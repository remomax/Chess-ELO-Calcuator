...
foreach ($list as $key => $value) {
   $gameid_display = '<td style="padding: 10px"> ' . $value->getGameID() . '</td><br>';
   $username_white_display = '<td style="padding: 10px">'. $username_white. '</td><br>';
   $username_black_display = '<td style="padding: 15px">' .$username_black. '</td><br>';
   $gameoutcome_display = '<td style="padding: 10px">'. $value->getGameoutcome(). '</td><br>';
   $EloWhiteBefore_display = '<td style="padding: 10px">' .$value->getEloWhiteBefore(). '</td><br>';
   $EloWhiteAfter_display = '<td style="padding: 10px">' .$value->getEloWhiteAfter(). '</td><br>';
   $EloBlackBefore_display = '<td style="padding: 10px">' .$value->getEloBlackBefore(). '</td><br>';
   $EloBlackAfter_display = '<td style="padding: 10px">'. $value->getEloBlackAfter(). '</td><br>';
   $K_display = '<td style="padding: 10px">' .$value->getK(). '</td><br>';
   $Time_display = '<td style="padding: 10px">' .$value->getTime(). '</td><br>';
}
